(function () {
    ...
    document.querySelectorAll('.product-card').forEach(card => {
        ...
        function currentVariant() {
            ...
            const variantPrice = opt.getAttribute('data-price'); // Get price from variant if available
            return { variant_id: variantId, label: opt.textContent, price: variantPrice };
        }
        ...
        variantSelect?.addEventListener('change', () => {
            ...
            if (v.price && priceEl) {
                priceEl.dataset.price = v.price;
                priceEl.textContent = currency(v.price);
            }
        });
    ...
    // checkoutBtn handled by Bootstrap data-bs-target in HTML
